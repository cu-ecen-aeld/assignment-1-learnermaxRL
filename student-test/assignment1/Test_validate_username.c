...
void test_validate_my_username()
{
    ...
    const char* actual = malloc_username_from_conf_file("conf/username.txt");

    const char* username_expected =  my_username();



    TEST_ASSERT_EQUAL_STRING_MESSAGE(username_expected,actual,"Username matches");
